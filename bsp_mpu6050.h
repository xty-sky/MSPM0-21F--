...
// [切口 C]: bsp_mpu6050.h 末尾
extern float g_Yaw_Offset;
extern float g_Raw_Yaw;    /* [2026-06-10 诊断] DMP原始yaw(±180°), 供遥测对比解卷绕yaw */
// Normalize_Angle 声明已移至 pid.h

// 建立快捷获取逻辑角度的宏
// NOTE: 这里保留广义相对航向，不做 ±180° 归一化，
// 以避免角度积分发生多圈转向时出现虚假跳变。
#define GET_RELATIVE_YAW()  (yaw - g_Yaw_Offset)
#define GET_NORMALIZED_YAW()  Normalize_Angle(yaw - g_Yaw_Offset)
//设置SDA输出模式
#define SDA_OUT()   {                                                  \
